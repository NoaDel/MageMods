...
namespace MageMods
{
    ...
    public class CompAbilityEffect_PsychicScream : CompAbilityEffect
    {
        private List<IntVec3> tmpCells = new List<IntVec3>();

        private new CompProperties_AbilityPsychicScream Props => (CompProperties_AbilityPsychicScream)props;
        ...
        public override void Apply(LocalTargetInfo target, LocalTargetInfo dest)
        {
            ...
            GenExplosion.DoExplosion(affectedAngle: new FloatRange(num - 10f, num + 10f), center: position, map: parent.pawn.MapHeld, radius: Props.range, damType: DamageDefOf.Flame, instigator: Pawn, damAmount: Mathf.CeilToInt(15*(parent.pawn.GetStatValue(StatDefOf.PsychicSensitivity))), armorPenetration: (.5f * (parent.pawn.GetStatValue(StatDefOf.PsychicSensitivity))), explosionSound: null, weapon: null, projectile: null, intendedTarget: null, postExplosionSpawnChance: 1f, postExplosionSpawnThingCount: 1, postExplosionGasType: null, applyDamageToExplosionCellsNeighbors: false, preExplosionSpawnThingDef: null, preExplosionSpawnChance: 0f, preExplosionSpawnThingCount: 1, damageFalloff: false, direction: null, doVisualEffects: false, propagationSpeed: 0.6f, excludeRadius: 0f, doSoundEffects: false);
        ...
        public override IEnumerable<PreCastAction> GetPreCastActions()
        {
            yield return new PreCastAction
            {
                ...
                {
                    parent.AddEffecterToMaintain(EffecterDefOf.Fire_Spew.Spawn(parent.pawn.Position, a.Cell, parent.pawn.Map), Pawn.Position, a.Cell, 17, Pawn.MapHeld);
                },
